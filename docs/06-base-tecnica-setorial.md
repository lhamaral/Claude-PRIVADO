# Base técnica — a reforma no setor de bares e restaurantes

> **Como ler este documento.** Ele reúne o que sustenta os roteiros. Cada ponto tem
> um marcador de confiança:
>
> - ✅ **Firme** — texto expresso, amplamente assentado. Pode ir ao ar.
> - ⚠️ **[VALIDAR]** — correto na essência, mas confira dispositivo, percentual ou
>   redação atualizada antes de afirmar em vídeo.
> - 🔶 **Em disputa** — a norma existe, o alcance não está pacificado. Vá ao ar
>   dizendo que não está pacificado.
>
> Última checagem das fontes: **agosto de 2026**. Reconfira antes de cada bloco de
> gravação — a regulamentação é recente e está se movendo.

---

## 1. O desenho geral

✅ A **EC nº 132/2023** substituiu cinco tributos sobre consumo por um IVA dual:

| Novo | Substitui | Competência |
|---|---|---|
...
| **IS** — Imposto Seletivo | — | Federal, extrafiscal |

✅ A **LC nº 214/2025** (publicada em 16/01/2025) instituiu os tributos e criou, nos
**arts. 273 a 276**, o regime específico de bares e restaurantes.

✅ A regulamentação veio em abril de 2026: **Decreto nº 12.955/2026** (CBS, de
29/04/2026) e **Resolução CGIBS nº 6/2026** (IBS, de 30/04/2026).

### Onde estamos hoje (agosto de 2026)

✅ **2026 — ano-teste.** CBS a **0,9%** e IBS a **0,1%**, com mecanismo de
compensação/dispensa vinculado ao cumprimento das obrigações acessórias. O objetivo
...
## 2. O regime específico do setor (arts. 273 a 276)
...
✅ Alimentação **e bebidas não alcoólicas** preparadas no próprio estabelecimento.

🔶 O **Decreto nº 12.955/2026, art. 396** condiciona o regime a bens "preparados e
manipulados no próprio local do estabelecimento" — e **não define** o que constitui
preparo ou manipulação. Este é hoje o maior foco de insegurança jurídica do setor.

Perguntas abertas de altíssimo valor editorial (episódios E09 e E10):
- Refrigerante em lata, apenas aberto e servido com gelo — há "preparo"?
- Sobremesa comprada pronta de fornecedor e apenas emplatada?
- Pão de queijo congelado, assado na casa?
- Produto de padaria vendido no balcão sem consumo no local?

A intenção declarada da restrição é impedir que bares e restaurantes operem como
**meros revendedores** com alíquota reduzida.
...
majoritariamente chope e destilado **quase não usufrui** do regime dos 40%. O
"desconto do setor" é, na prática, um desconto de restaurante — não de bar.

### A contrapartida: a trava de crédito

✅ **Art. 276 da LC 214/2025 — veda o crédito de IBS/CBS ao adquirente** de
alimentação e bebidas de bares, restaurantes e lanchonetes.
...
🔶 **Problema operacional real:** não há responsabilização clara das plataformas
(iFood, Rappi, Uber Eats) por segregar esses valores no documento fiscal. Sem a
segregação correta, o restaurante pode acabar tributando sobre os R$ 100. Isso
rende episódio e rende trabalho.
...
| | Dentro do DAS (Simples "híbrido") | Regime regular de IBS/CBS |
|---|---|---|
| Recolhimento | Tudo na guia única | IBS/CBS por fora; demais tributos no DAS |
| Crédito transferido ao cliente | Reduzido | Cheio |
| Crédito das próprias compras | Não aproveita | Aproveita, pelas regras gerais |
| Complexidade | Baixa | Alta |

### A regra de bolso

- Vende **ao consumidor final** → dentro do DAS tende a compensar. O cliente não
  aproveita crédito nenhum mesmo, e a guia única é mais barata de operar.
...
✅ Mecanismo que separa IBS e CBS **no momento da liquidação do pagamento**: o
documento fiscal calcula o tributo, a informação vai ao meio de pagamento, e a
...
clareza, porque circula muito pânico sobre o tema.

**O que importa mesmo:** capital de giro. Hoje o restaurante recebe o valor cheio,
usa esse dinheiro por alguns dias e recolhe o imposto depois. Com o split, o tributo
sai antes. Para um setor de margem apertada e forte uso de cartão e voucher, é uma
mudança estrutural de fluxo de caixa — mesmo que escalonada.
...
nota do distribuidor e compare o custo da caixa de cerveja com a de hoje".
...
- [ANR — Regulamentação do IBS e CBS para bares e restaurantes](https://anrbrasil.org.br/publicacao-da-regulamentacao-da-reforma-tributaria-do-consumo-ibs-e-cbs-para-bares-e-restaurantes/)
- [Conjur — Estado da arte da regulamentação para hotéis, restaurantes e bares (ago/2026)](https://conjur.com.br/2026-ago-04/reforma-tributaria-em-marcha-o-estado-da-arte-da-regulamentacao-para-hoteis-restaurantes-e-bares/)
- [Migalhas — Bares e restaurantes na reforma: benefício ou custo oculto?](https://www.migalhas.com.br/depeso/457724/bares-e-restaurantes-na-reforma-beneficio-ou-custo-oculto)
- [Maran, Gehlen & Advogados — Arts. 273 a 276 da LC 214/2025](https://marangehlen.adv.br/reforma-tributaria-bares-e-restaurantes-art-273-a-276-da-lc-214-2025/)
- [TAGD Advogados — Parecer sobre a tributação do IBS e CBS nos bares e restaurantes](https://tagdlaw.com.br/reforma-tributaria-parecer-sobre-a-tributacao-do-ibs-e-cbs-nos-bares-e-restaurantes/)
- [Rota da Jurisprudência — A face dupla do regime especial de restaurantes](https://rotadajurisprudencia.com.br/2026/05/reducao-de-40-que-quebra-a-cadeia-a-face-dupla-do-regime-especial-de-restaurantes-na-lc-214-2025/)
- [Receita Federal — CGSN define prazos de opção pelo Simples e pelo regime regular para 2027](https://www.gov.br/receitafederal/pt-br/assuntos/noticias/2026/abril/cgsn-define-prazos-de-opcao-pelo-simples-nacional-e-pelo-regime-regular-do-ibs-e-da-cbs-para-2027)
- [Finsiders — Split payment: regulamento de CBS e IBS](https://finsidersbrasil.com.br/regulamentacao/split-payment-2027-regulamento-cbs-ibs-reforma-tributaria/)
- [Mundo Food Service — Split payment no food service (guia 2026)](https://mundofoodservice.com.br/split-payment-no-food-service-o-que-e-quando-comeca-e-como-preparar-seu-restaurante-guia-2026/)

> Fontes secundárias servem para orientar a pesquisa, não para fundamentar afirmação
> em vídeo. Antes de gravar, confira no texto da LC 214/2025, do Decreto nº
> 12.955/2026 e da Resolução CGIBS nº 6/2026.
